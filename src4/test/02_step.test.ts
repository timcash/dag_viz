...
async function run() {
    ...
    try {
        ...
        lib.startStep("Step 2: Auto-generated Template");
        ...
        if (!isImplemented) {
            ...
            throw new Error("Step 2 not yet implemented by agent");
        }

        await lib.page.evaluate(() => {
            const app = (window as any).app;
            const THREE = (window as any).THREE;
            app.moveCamera(new THREE.Vector3(0, 20, 50), new THREE.Vector3(0, 0, 0), 1.0, "Over-Shoulder");
        });
        ...
        if (isGreen) {
            ...
            throw new Error("Step 2 Visual Verification Failed: Expected Green");
        }
    } catch (e) {
