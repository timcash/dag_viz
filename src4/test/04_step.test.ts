...
async function run() {
    ...
    try {
        ...
        lib.startStep("Step 4: Auto-generated Template");
        ...
        if (!isImplemented) {
            ...
            throw new Error("Step 4 not yet implemented by agent");
        }
        ...
        await lib.page.evaluate(() => {
            ...
            app.moveCamera(new THREE.Vector3(-50, 20, 0), new THREE.Vector3(0, 0, 0), 0.5);
        });
        ...
        if (!isBackground) {
            ...
            throw new Error("Step 4 Visual Verification Failed: Cube not visible");
        }
    } catch (e) {
